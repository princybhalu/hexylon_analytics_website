          ...
          <div className="footer-content grid md:grid-cols-4 gap-8 items-start">
            ...
            <div className="fade-up">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="hover:text-[#FF6600] cursor-pointer transition-colors">Our Work</li>
                <li className="hover:text-[#FF6600] cursor-pointer transition-colors">About Us</li>
